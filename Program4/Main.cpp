/**
	Following tasks are performed:
		1. Conceal your own identity in a live webcam stream and facial regions corresponding 
			to any other person should remain unaltered.
		Haarcascade classifier is trained to detect faces.
		Fisher Face Recogizer model is trained with the user's face to detect just him/her.
